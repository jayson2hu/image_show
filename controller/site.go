...
func SiteConfig(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		...
		"guest_generation_limit":         service.GuestGenerationLimit(),
		"guest_layered_generation_limit": service.GuestLayeredGenerationLimit(),
		"user_generation_limit":          service.UserGenerationLimit(),
		"user_layered_generation_limit":  service.UserLayeredGenerationLimit(),
	})
}
